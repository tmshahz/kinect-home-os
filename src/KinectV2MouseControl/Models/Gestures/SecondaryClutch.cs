...
{
    /// <summary>
    /// The secondary-hand fist clutch that arms scroll and swipe.
    ///
    /// The secondary hand is passive by default. Raising or moving it does nothing; only a
    /// deliberately closed fist, held inside the activation zone, arms the secondary vocabulary.
    /// Opening the fist disarms it. This is what lets the secondary hand rest or reposition
    ...
    /// look at a physical hand's open/closed state themselves.
    /// </summary>
    public class SecondaryClutch
    {
        ...
        /// <param name="hand">The hand assigned the secondary role for this frame.</param>
