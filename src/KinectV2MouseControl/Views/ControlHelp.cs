...
namespace KinectV2MouseControl
{
    ...
    public static class ControlHelp
    {
        ...
        public static readonly List<HelpEntry> Entries = new List<HelpEntry>
        {
            ...
            new HelpEntry("Widget chat panel", "Slide-down conversation on the compact widget. Recent assistant steps, a one-line request box, and Cancel while a request is running. Remembers open or closed across restarts. Opens on its own when the assistant starts working.", null, null, null, null),
